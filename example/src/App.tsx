...
import { Builder, Container, SerializedContainer } from 'formial'
...
const App = () => {
    ...
    return (
        <div id="example-builder">
            <div><button onClick={() => setValue({...NEW})}>Update</button></div>

            <Builder onChange={onChange} value={value} defaultValue={DEFAULT} />
        </div>
    )
}
