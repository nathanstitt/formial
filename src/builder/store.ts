...
export function isContainerOrElement(toBeDetermined: Container|Element): toBeDetermined is Container {
...
export function addElement(
    ...
    // const { id, fromIndex } = options
    // let { destIndex } = options
    console.log("ADD EL: ", arguments[1])
...
//    console.log(container.children.map(c => c.id))
    return { ...store }
}
...
export const useStoreReducer = () => {
    return React.useReducer(storeReducer, {}, initStore)
}
